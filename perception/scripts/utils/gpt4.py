...
def group(image_path,ground_truth_ids:list):
	# image_path = "/home/orin/planner_ws/src/perception/scripts/utils/saved_image.jpg"
...
def group_debug(ground_truth_ids:list):
	image_path = "/home/orin/planner_ws/src/perception/keyframes/2024-09-11_213322/3405.jpg"
	base64_image = encode_image(image_path)
	client = OpenAI()
	start_time = time.time()
	response = client.chat.completions.create(
...
def handle(image,ground_truth_ids):
    filename = "/home/orin/planner_ws/src/perception/keyframes/2024-09-11_213322/3405.jpg"  
...
if __name__ == '__main__':
	try:
		...
		path = "/home/orin/planner_ws/src/perception/keyframes/2024-09-11_215924/846.jpg"
		# path = "/home/orin/planner_ws/src/perception/keyframes/2024-09-07_182135445.jpg"  
